...
% TODO: Describe this process more precisely
...
\begin{itemize}
	...
	\item The \verb|max_features| parameter (number of features) specifies the the number of features of the data considered for a split at each node while growing an individual tree. A higher value of \verb|max_features| may capture more information about the data at the risk
	      % TODO: why at the risk of overfitting?
...
\begin{itemize}
	% TODO: Clarify that it is not kernel from GAL
	\item \textbf{Kernel:} The model uses a kernel function to transform the space of data points which are not separable by a hyperplane, into one where they are separable.
	      ...
	      % TODO: What is X, Z et. should be at beginning
	...
	\item \textbf{C value:} The \(C\) value specifies how accurate the model should be, that is how much it should avoid misclassifications, versus how wide the margins should be. A lower value of \(C\) corresponds to wider margins. % TODO: in what metric: %, count?
...
where
\begin{itemize}
	\item $\eta$ is the learning rate, % TODO: why is it not infinite?
...
% TODO: example?
% TODO: in below, what is the range of x y m n?
